...
echo "calculate Pi / heterozigosity within individuals"
# OPTION -o 1 (to be comparable with rSFS, only useful for diploid individuals)
./mstatspop -f ms -i ./slim.snm.output_all.ms -o 1 -N 50 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 -n ./chr_ext.txt -l 1000000 -r $NITER -F 1 -T ./slim.snm.output_file.ms_mstatspopo1PI.txt
./mstatspop -f ms -i ./slim.selsweep.output_all.ms -o 1 -N 50 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 -n ./chr_ext.txt -l 1000000 -r $NITER -F 1 -T ./slim.selsweep.output_file.ms_mstatspopo1PI.txt
./mstatspop -f ms -i ./slim.incomplete_selsweep.output_all.ms -o 1 -N 50 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 -n ./chr_ext.txt -l 1000000 -r $NITER -F 1 -T ./slim.incomplete_selsweep.output_file.ms_mstatspopo1PI.txt
./mstatspop -f ms -i ./slim.standing_selsweep.output_all.ms -o 1 -N 50 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 -n ./chr_ext.txt -l 1000000 -r $NITER -F 1 -T ./slim.standing_selsweep.output_file.ms_mstatspopo1PI.txt

echo "keep desired Pi columns with 4 different conditions"
perl ./collect_data_columns.pl -in  ./slim.snm.output_file.ms_mstatspopo1PI.txt  -fc columns_to_choose.txt > ./slim.snm.output_file.ms_mstatspopo1PI.txt.columns.txt
perl ./collect_data_columns.pl -in  ./slim.selsweep.output_file.ms_mstatspopo1PI.txt   -fc columns_to_choose.txt > ./slim.selsweep.output_file.ms_mstatspopo1PI.txt.columns.txt
perl ./collect_data_columns.pl -in  ./slim.incomplete_selsweep.output_file.ms_mstatspopo1PI.txt   -fc columns_to_choose.txt > ./slim.incomplete_selsweep.output_file.ms_mstatspopo1PI.txt.columns.txt
perl ./collect_data_columns.pl -in  ./slim.standing_selsweep.output_file.ms_mstatspopo1PI.txt  -fc columns_to_choose.txt > ./slim.standing_selsweep.output_file.ms_mstatspopo1PI.txt.columns.txt
